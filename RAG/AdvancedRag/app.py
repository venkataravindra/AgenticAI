...
# ============================================================
# CHANGE 1: Import FAISS instead of Chroma
# ============================================================
...
# ============================================================
# CHANGE 2: Initialize FAISS (no persistence directory needed)
# FAISS will be initialized as None and created when first document is added
# ============================================================
vector_store = None  # Will be initialized when first document is added
FAISS_INDEX_PATH = "faiss_index"  # Directory to save/load FAISS index

# ============================================================
# CHANGE 3: Function to load existing FAISS index if available
# ============================================================
...
def ingest_document(file_path: Path):
    ...
    # ============================================================
    # CHANGE 4: Add documents to FAISS with different logic
    # ============================================================
    if vector_store is None:
        ...
        # Subsequent documents: Add to existing FAISS index
        vector_store.add_documents(documents=chunks)
    
    # ============================================================
    # CHANGE 5: Save FAISS index to disk after each addition
    # ============================================================
...
def retrieve_candidates(
    ...
    """
    Search FAISS using multiple queries.
    ...
    # ============================================================
    # CHANGE 6: Check if vector_store exists
    # ============================================================
    if vector_store is None:
        return []
    ...
    for query in queries:
        # ============================================================
        # CHANGE 7: FAISS uses similarity_search with same interface
        # ============================================================
        documents = (
